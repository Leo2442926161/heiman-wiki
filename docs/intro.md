...
- **Smart Gas Safety**: Gas leak detection and remote shut-off solutions
- **Smart Elderly Care**: Fall detection, emergency call, and elderly safety monitoring solutions
- **Smart Sensing**: PIR sensors, presence sensors, door/window sensors, temperature/humidity sensors, water leak sensors, air quality sensors, etc.
